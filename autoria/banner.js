...
function abjqlr(o) {
    ...
    l = window, r = document.documentElement, i = "async-hide", s = "dataLayer", _ = {"GTM-P46SHG8": !0}, r.className += " " + i, _.start = +new Date, _.end = p = function () {
        ...
        }), console.log("Уточнить о наличии"), document.querySelectorAll("#react_phones_bottom .phones_item:first-child .cro-button")[0].click();
