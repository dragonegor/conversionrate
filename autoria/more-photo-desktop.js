let style = `
  ...
  *, *::before, *::after {
  ...
  .more-img-popup .popup-content > div:last-child > *:not(:last-child) {
    margin-bottom: 12px;
  }
  .more-img-popup .popup-content > div {
    width: 47%;
  }
  .more-img-popup .popup-content > div:first-child {
    display: flex;
    align-items: center;
  }
  .more-img-popup .popup-content > div:first-child img {
    height: 100%;
    width: 100%;
    object-fit: contain;
  }
  .more-img-popup .popup-content h3 {
    font-size: 21px;
    font-weight: 700;
  }
  .more-img-popup .popup-content .step {
    font-size: 13px;
  }
  .more-img-popup .popup-content .step b {
    margin-right: 5px;
  }
  .more-img-popup .popup-content .popup-phone-block {
    border-radius: 6px;
  ...
  .more-img-popup .popup-content .popup-phone-block > *:not(:last-child) {
    margin-bottom: 8px;
  }
  .more-img-popup .popup-content .popup-phone-block .phone {
    font-size: 26px;
    font-weight: 700;
    color: #3C9806;
  }
  .more-img-popup .popup-content .popup-phone-block .work-time {
    color: #9B9B9B;
  }
  .more-img-popup .popup-content .popup-phone-block .or {
    position: relative;
    display: inline-block;
  }
  .more-img-popup .popup-content .popup-phone-block .or::before, .more-img-popup .popup-content .popup-phone-block .or::after {
    content: "";
    display: block;
    position: absolute;
    height: 1px;
  ...
  .more-img-popup .popup-content .popup-phone-block .or::before {
    right: 150%;
  }
  .more-img-popup .popup-content .popup-phone-block .or::after {
    left: 150%;
  }
  .more-img-popup .popup-content .popup-phone-block form {
    display: flex;
    height: 40px;
  }
  .more-img-popup .popup-content .popup-phone-block form label {
    position: relative;
  }
  .more-img-popup .popup-content .popup-phone-block form label:first-child {
    width: 55%;
  }
  .more-img-popup .popup-content .popup-phone-block form label:last-child {
    width: 45%;
  }
  .more-img-popup .popup-content .popup-phone-block form label svg {
    position: absolute;
    height: 12px;
    left: 14px;
    top: 14px;
  }
  .more-img-popup .popup-content .popup-phone-block form input[type=tel] {
    width: 100%;
    height: 100%;
    border: 1px solid #9B9B9B;
  ...
  .more-img-popup .popup-content .popup-phone-block form input[type=tel]::placeholder {
    font-family: "Arial", sans-serif;
    font-size: 13px;
    color: #9B9B9B;
  }
  .more-img-popup .popup-content .popup-phone-block form input[type=submit] {
    width: 100%;
    height: 100%;
  ...
  <div class="popup-content">
    ...
    <div>
      ...
      <form action="">
        ...
        <label><input type="submit" value="Подзвонити мені"></label>
      </form>
    </div>
    <p class="step"><b>2</b>Поясніть, які саме фото ви хочете побачити.</p>
    <p class="step"><b>3</b>Домовтеся, яким способом вам зручно отримати фото (Viber, Telegram, email та ін.).</p>
  </div>
</div>
<div class="close">
  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="more-img-popup">
    <div class="popup-content">
      ...
      <div>
        ...
        <p>и вам перезвонят</p>
        <form action="">
          <label>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M2.75387 0.980217C2.91787 0.816198 3.11487 0.688926 3.3318 0.606844C3.54874 0.524763 3.78065 0.489747 4.01215 0.504121C4.24365 0.518495 4.46944 0.58193 4.67456 0.690218C4.87967 0.798505 5.05942 0.94917 5.20187 1.13222L6.88287 3.29422C7.19187 3.69022 7.30087 4.20722 7.17887 4.69422L6.66587 6.74722C6.63919 6.85375 6.64055 6.96537 6.66981 7.07121C6.69908 7.17706 6.75525 7.27353 6.83287 7.35122L9.13687 9.65422C9.21456 9.73183 9.31102 9.78801 9.41687 9.81727C9.52272 9.84654 9.63434 9.8479 9.74087 9.82122L11.7929 9.30822C12.0336 9.24811 12.2848 9.24352 12.5275 9.2948C12.7702 9.34608 12.9981 9.45189 13.1939 9.60422L15.3559 11.2852C16.1329 11.8892 16.2049 13.0382 15.5089 13.7332L14.5389 14.7032C13.8459 15.3962 12.8089 15.7012 11.8419 15.3612C9.36827 14.4906 7.12242 13.0742 5.27087 11.2172C3.41351 9.36576 1.99681 7.1199 1.12587 4.64622C0.785867 3.67922 1.09087 2.64222 1.78387 1.94822L2.75387 0.979217V0.980217Z"
                    fill="#9B9B9B"/>
            </svg>
            <input type="tel" placeholder="(000) 000 00 00">
          </label>
          <label><input type="submit" value="Позвонить мне"></label>
        </form>
        </div>
    ...
    <div class="close">
      <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            d="M7.17495 5.9995L10.7583 2.4245C10.9152 2.26758 11.0034 2.05476 11.0034 1.83284C11.0034 1.61092 10.9152 1.39809 10.7583 1.24117C10.6014 1.08425 10.3885 0.996094 10.1666 0.996094C9.9447 0.996094 9.73187 1.08425 9.57495 1.24117L5.99995 4.8245L2.42495 1.24117C2.26803 1.08425 2.0552 0.996094 1.83328 0.996094C1.61136 0.996094 1.39854 1.08425 1.24162 1.24117C1.0847 1.39809 0.996539 1.61092 0.996539 1.83284C0.996539 2.05476 1.0847 2.26758 1.24162 2.4245L4.82495 5.9995L1.24162 9.57451C1.16351 9.65197 1.10151 9.74414 1.05921 9.84569C1.0169 9.94724 0.995117 10.0562 0.995117 10.1662C0.995117 10.2762 1.0169 10.3851 1.05921 10.4867C1.10151 10.5882 1.16351 10.6804 1.24162 10.7578C1.31909 10.8359 1.41125 10.8979 1.5128 10.9402C1.61435 10.9826 1.72327 11.0043 1.83328 11.0043C1.94329 11.0043 2.05221 10.9826 2.15376 10.9402C2.25531 10.8979 2.34748 10.8359 2.42495 10.7578L5.99995 7.1745L9.57495 10.7578C9.65242 10.8359 9.74459 10.8979 9.84614 10.9402C9.94769 10.9826 10.0566 11.0043 10.1666 11.0043C10.2766 11.0043 10.3855 10.9826 10.4871 10.9402C10.5886 10.8979 10.6808 10.8359 10.7583 10.7578C10.8364 10.6804 10.8984 10.5882 10.9407 10.4867C10.983 10.3851 11.0048 10.2762 11.0048 10.1662C11.0048 10.0562 10.983 9.94724 10.9407 9.84569C10.8984 9.74414 10.8364 9.65197 10.7583 9.57451L7.17495 5.9995Z"
            fill="#9B9B9B"/>
      </svg>
    </div>
  </div>`
